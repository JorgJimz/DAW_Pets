...
namespace DAW_Pets
{
    public class MascotaController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Raza,Color,Edad,Tipo,Descripcion,Direccion,Situacion,Observaciones,Alimentacion,EsperanzaVida,ActividadFisica,Peso,Altura,Tamaño,Clima,Habitat,Caracter")] Mascota mascota)
        {
            if (id != mascota.Id)
            {
                return NotFound();
